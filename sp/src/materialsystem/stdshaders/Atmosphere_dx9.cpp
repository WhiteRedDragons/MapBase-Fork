//==================================================================================================
//
// Fake Atmosphere shader with lightsource to alpha calculations
//
//==================================================================================================
...
// Includes for PS20b
//#include "include/Atmosphere_vs20.inc"
//#include "include/Atmosphere_ps20b.inc"
...
SHADER_INIT
{
	...
	SET_FLAGS(MATERIAL_VAR_MODEL);
		...
		SET_FLAGS2(MATERIAL_VAR2_DIFFUSE_BUMPMAPPED_MODEL);         // Required for dynamic lighting, even though we have no bumping we set it BECAUSE : no particular reason
		...
		SET_FLAGS2(MATERIAL_VAR2_NEEDS_BAKED_LIGHTING_SNAPSHOTS);   // Required for ambient cube, even though we have no bumping we set it BECAUSE : no particular reason
...
SHADER_DRAW
{
	...
	if (IsSnapshotting())
	{
		...
		// WRD: If you put this thing underwater I will annihilate your entire family line
	...
	else // Not snapshotting -- begin dynamic state
	{
		...
		// Also StaticLightTexel appears to be entirely unused *and* doesn't exist in sdk2013sp.
	...
	// just here as a reference for now
	// pShaderAPI->SetPixelShaderConstant(27, flParams, 1);
		...
		// last 1 here is whether or not to force
		pShaderAPI->SetPixelShaderConstant(27, AtmosphereControl, 1);

		// Original shaders didn't do this, and it disgusts me because the g_EyePos on the shader doesn't consider 3d skybox lol
